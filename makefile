...
OBJS = $(BUILD_DIR)/main.o $(BUILD_DIR)/init.o $(BUILD_DIR)/interrupt.o \
	  ...
	  $(BUILD_DIR)/fork.o $(BUILD_DIR)/shell.o $(BUILD_DIR)/buildin_cmd.o $(BUILD_DIR)/exec.o
...
$(BUILD_DIR)/init.o: kernel/init.c kernel/init.h lib/kernel/print.h \
		...
		userprog/syscall-init.h fs/fs.h
	$(CC) $(CFLAGS) $< -o $@
...
$(BUILD_DIR)/console.o: device/console.c device/console.h \
		lib/kernel/print.h thread/sync.h lib/stdint.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/keyboard.o: device/keyboard.c device/keyboard.h \
		lib/kernel/print.h lib/kernel/io.h kernel/interrupt.h \
		kernel/global.h device/keyboard.h
	$(CC) $(CFLAGS) $< -o $@
...
hd:
	dd if=$(BUILD_DIR)/kernel.bin \
           of=/home/vacancy/bochs/bin/hd60M.img \
